...
window.PRIDE2 = {
  ...
  entrants: [
    ...
    { seed: 6,  name: "りーぬちゃん🐹🌻" },
    { seed: 7,  name: "🐉参戦・伝説のツチノトちゃん🧡💫登竜門がんばる😡🔮" },
    { seed: 8,  name: "nunu🍫🩵" },
    { seed: 9,  name: "ゆあ🐶🍫" },
  ...
  rounds: [
    { name: "1回戦", date: "9/20(日)", matches: [
      ...
      { id: "R1-2", at: "2026-09-20T22:00:00+09:00",
        a: { seed: 6, name: "りーぬちゃん🐹🌻" }, b: { seed: 7, name: "🐉参戦・伝説のツチノトちゃん🧡💫登竜門がんばる😡🔮" }, winner: "" }
    ]},
    { name: "準々決勝", date: "9/24(木)", matches: [
      ...
      { id: "QF-3", at: "2026-09-24T22:00:00+09:00", src: [],
        a: { seed: 3, name: "ぐでち。🍳💫", bye: true },          b: { seed: 10, name: "さーたん🎀👑登竜門参戦🐉", bye: true }, winner: "" },
      { id: "QF-4", at: "2026-09-24T22:00:00+09:00", src: [1],
